...
class DataSourceCallsAggregationAspectTest {
    ...
    private final MultiTenantDataSourceProperties.DataSourceDefinition firstDefinition = Mockito.mock(MultiTenantDataSourceProperties.DataSourceDefinition.class);
    private final MultiTenantDataSourceProperties.DataSourceDefinition secondDefinition = Mockito.mock(MultiTenantDataSourceProperties.DataSourceDefinition.class);
    ...
    void aggregateCallsTest() throws Throwable {
        ...
        TargetDataSourceContextHolder.DataSourceContext context1 = new TargetDataSourceContextHolder.DataSourceContext(firstDatabaseName);
        TargetDataSourceContextHolder.DataSourceContext context2 = new TargetDataSourceContextHolder.DataSourceContext(secondDatabaseName);
        List<MultiTenantDataSourceProperties.DataSourceDefinition> definitions = List.of(firstDefinition, secondDefinition);
