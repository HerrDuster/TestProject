...
class RoutingDataSourceTest {
    ...
    private final TargetDataSourceContextHolder.DataSourceContext context = Mockito.mock(TargetDataSourceContextHolder.DataSourceContext.class);
    private final MultiTenantDataSourceProperties.DataSourceDefinition definition1 = Mockito.mock(MultiTenantDataSourceProperties.DataSourceDefinition.class);
    private final MultiTenantDataSourceProperties.DataSourceDefinition definition2 = Mockito.mock(MultiTenantDataSourceProperties.DataSourceDefinition.class);
